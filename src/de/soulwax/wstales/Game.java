// File: src/de/soulwax/wstales/Game.java

package de.soulwax.wstales;
...
import de.soulwax.wstales.gfx.SpriteSheet;
import de.soulwax.wstales.level.Level;
import de.soulwax.wstales.level.tile.Tile;
import de.soulwax.wstales.screen.DeadMenu;
import de.soulwax.wstales.screen.LevelTransitionMenu;
import de.soulwax.wstales.screen.Menu;
import de.soulwax.wstales.screen.TitleMenu;
import de.soulwax.wstales.screen.WonMenu;
    ...
    private void initializeScreens() {
        try {
            screen = new Screen(WIDTH, HEIGHT,
                    new SpriteSheet(
                            ImageIO.read(Objects.requireNonNull(Game.class.getResourceAsStream("/icons.png")))));
